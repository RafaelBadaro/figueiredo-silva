    ...
    return (
        <section className="py-32 px-6 md:px-12 bg-white" id="contato">
            <div className="w-full">
                <div className="w-full max-w-7xl mx-auto grid gap-16 lg:grid-cols-[1.1fr_0.9fr] items-center">
                        ...
                        <div className="rounded-3xl bg-surface-container-low p-10 shadow-lg shadow-slate-200/30">
                            <div className="space-y-8">
                                ...
                                <div>
                                    ...
                                    <a href="mailto:figueiredosilva@terra.com.br" className="text-base md:text-lg text-secondary hover:underline break-all">
                    ...
                    <div className="rounded-3xl overflow-hidden border border-outline w-full">
                        <iframe
